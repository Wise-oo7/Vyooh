  ...
  return (
    <div className="about-page">
      ...
      <div className="image-box">
        <img 
          src="f.jpg" // Replace with your actual image URL
          alt="About Us"
      ...
      <div className="article-box">
        <h3>Our Story</h3>
        <p>
          Vyuha's mission is to empower individuals through the ancient wisdom of strategy, 
          ...
          As a unique platform dedicated to the art of Vyuha, we aim to bridge history with modern 
        ...
        <h2>Our Values</h2>
        <p>
          At Vyuha, we are committed to fostering a respectful, thoughtful, and stimulating environment. 
        ...
        <ul>
          ...
          <li><strong>Learning through Experience:</strong> Every challenge in Vyuha is designed to teach 
          ...
          <li><strong>Enjoyment through Strategy:</strong> While Vyuha is rooted in serious intellectual 
